...
<div class="">
  <div class="page-title">
    <div class="title_left w-100">
      <h3>Pendaftar <span class="text-secondary" style="font-size:0.6em">Pon.Pes Darussalam Dukuhwaluh Purwokerto</span></h3>
    </div>
  </div>
      ...
      <div class="x_panel">
        <div class="x_content">
          ...
          <div class="form-group row">
            <div class="col-md-4 mb-1"><input class="form-control form-control-sm" type="text" id="pengguna_nik" placeholder="NIK" /></div>
