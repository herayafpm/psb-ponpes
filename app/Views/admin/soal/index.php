...
<div class="">
  <div class="page-title">
    <div class="title_left w-100">
      <h3>Soal <span class="text-secondary" style="font-size:0.6em">Pon.Pes Darussalam Dukuhwaluh Purwokerto</span></h3>
    </div>
  </div>
      ...
      <div class="x_panel">
        <div class="x_content">
          ...
          <div class="form-group row">
            <div class="col-md-4 mb-1"><input class="form-control form-control-sm" type="text" id="soal_soal" placeholder="Soal" /></div>
          </div>
...
<script>
  ...
  $(document).ready(function() {
    tabel = $("#datatable-custom").DataTable({
      ...
      "columns": [{
        ...
        },
        {
          "render": function(data, type, row, meta) {
            var html = ''
            html += '<button type="button" class="btn btn-info btn-sm" onClick="edit(' + row.soal_id + ')">Edit</button>'
            html += '<button type="button" class="btn btn-danger btn-sm" onClick="hapus(' + row.soal_id + ')">Hapus</button>'
            return html
          }
        },
      ],
    ...
    $('#soal_soal').on('keyup change clear', function() {
      var value = $(this).val();
      data.soal_soal = value;
